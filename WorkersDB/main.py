...
def search(worker_db):
    key = input("Enter key to search by (name, surname, department, salary): ")
...
def sort(worker_db):
    ...
    key = input("Enter key to sort by (name, surname, department, salary): ")
...
def edit_element(worker_db):
    ...
    key_to_edit = input("Enter key to edit (name, surname, department, salary): ")
